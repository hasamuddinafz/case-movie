            ...
            axios.get('https://imdb-top-100-movies.p.rapidapi.com',
                {
                    ...
                    headers: {
                        ...
                        'x-rapidapi-key': '2630866199mshc073eb946580cb4p19b937jsn710f6b762b55'
                    },
    ...
    return (
        <>
        <div className='dark:bg-darksmooth dark:text-white py-3 px-10 flex flex-col justify-between items-center lg:flex-row w-full'>
            <div className='navbar-brand'>
                <h1 className='font-bold text-xl lg:text-2xl text-center lg:text-left'>CineMax</h1>
            </div>
        ...
        <div className='dark:bg-darksmooth dark:text-white h-auto flex flex-col lg:flex lg:flex-row lg:h-auto'>
            <div className="dark:bg-linedark bg-grayscale-20 py-10  lg:w-2/12 min-h-screen">
